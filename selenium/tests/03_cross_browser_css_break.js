...
// TEST 3: Cross-browser consistency + intentional CSS breakage
...
(async function crossBrowserCssBreak() {
  ...
  console.log(`▶ TEST 3 (Cross-browser CSS break): starting... [${browser}]`);
  ...
  try {
    ...
    if (clicked) {
      console.log('Unexpected: Google click worked even though CSS was broken');
    } else {
    ...
    await sleep(1500);
    console.log(`TEST 3 PASS: CSS break + heal works in ${browser}`);
  } catch (err) {
